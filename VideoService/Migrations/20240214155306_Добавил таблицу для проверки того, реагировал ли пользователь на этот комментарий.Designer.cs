...
namespace VideoService.Migrations
{
    ...
    [Migration("20240214155306_Добавил таблицу для проверки того, реагировал ли пользователь на этот комментарий")]
    partial class Добавилтаблицудляпроверкитогореагироваллипользовательнаэтоткомментарий
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("VideoService.Models.Comments.MainComment", b =>
                {
                    b.HasOne("VideoService.Models.Post", null)
